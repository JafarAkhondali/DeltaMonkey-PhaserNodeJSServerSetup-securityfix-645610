// npm-free Server by Jared Wilcurt AND NOW I AM TRYING TO :-D
// All you need to run this is an installed copy of Node.JS
// Put this next to the files yout want to serve and run: node server.js
...
http.createServer(function (request, response) {
	...
	fs.exists(filename, function (exists) {
		...
		// Assumig the file exists, read it
